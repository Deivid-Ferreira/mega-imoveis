						<div id="conteudo-interno">
							...
							<div id="bloco-titulo">	
								<p class="titulo blog">NOVIDADES</p>
							</div>
<?php
							...
							<div id="conteudo-blog-detalhes">
								...
								<p class="botao-topo"><a href="<?php echo $configUrl;?>novidades/">Voltar</a></p>
									<div id="imagem-detalhes">
										<p class="imagem-blog"><a rel="lightbox[roadtrip]" title="<?php echo $dadosBlog['nomeBlog'];?>" href="<?php echo $configUrlGer.'f/blog/'.$dadosImagem['codBlog'].'-'.$dadosImagem['codBlogImagem'].'-O.'.$dadosImagem['extBlogImagem'];?>"><img style="display:block;" src="<?php echo $configUrlGer.'f/blog/'.$dadosImagem['codBlog'].'-'.$dadosImagem['codBlogImagem'].'-O.'.$dadosImagem['extBlogImagem'];?>" width="100%"/></a></p>															
									</div>
...
?>
								<div id="outras">
									<div id="bloco-titulo" style="padding-top:0px">	
										<p class="titulo blog" style="font-size: 24px; margin-bottom:20px">Mais Imagens</p>
									</div>
<?php								
		$contO = 0;
...
?>		
									<p class="imagem-outras" style="<?php echo $margin;?>"><a rel="lightbox[roadtrip]" title="<?php echo $dadosBlog['nomeBlog'];?>" href="<?php echo $configUrlGer.'f/blog/'.$dadosImagens['codBlog'].'-'.$dadosImagens['codBlogImagem'].'-O.'.$dadosImagem['extBlogImagem'];?>" style="display:block; background:transparent url('<?php echo $configUrlGer.'f/blog/'.$dadosImagens['codBlog'].'-'.$dadosImagens['codBlogImagem'].'-O.'.$dadosImagem['extBlogImagem'];?>') center center no-repeat; background-size:cover, 100%;"></a></p>
<?php
		}
?>
									<br class="clear"/>
