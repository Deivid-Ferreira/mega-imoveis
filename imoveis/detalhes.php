...
?>
															<li style="position: relative; width: 390px; height: 350px; border-radius: 15px; overflow: hidden;"><a rel="lightbox[roadtrip]" href="<?php echo $configUrlGer.'f/imoveis/'.$dadosImagens['codImovel'].'-'.$dadosImagens['codImovelImagem'].'-W.webp'; ?>" style="display: block; width: 100%; height: 100%; background: transparent url('<?php echo $configUrlGer.'f/imoveis/'.$dadosImagens['codImovel'].'-'.$dadosImagens['codImovelImagem'].'-W.webp'; ?>') center center no-repeat; background-size: cover, 100%; "></a>
