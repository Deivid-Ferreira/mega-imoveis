<?php
	...
	if($cont == 0){
?>
		<p class="item" style="float:none; margin-right:0px; font-weight:bold;"><?php echo $value;?><span class="icone-novo" onMouseOver="mouseOverNovoItem();" onClick="novoItem('<?php echo $value;?>', 'proprietarios_c');">+ Novo Proprietario</span></p>		
<?php
	}
?>
		...
		<input type="hidden" value="proprietarios_c" id="id_autocomplete_softbest"/>
