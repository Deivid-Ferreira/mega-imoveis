				...
				<div id="filtro">							
					...
					<div class="demoTarget">
						...
						<div id="formulario-filtro">
							<form id="filtroStatus" action="<?php echo $configUrl;?>imoveis/proprietarios/" method="post">
					...
					<div id="cadastrar" style="display:<?php echo $block;?>; margin-left:30px; margin-top:30px; margin-bottom:30px;">			
						<script type="text/javascript">
							...
							function carregaCidade(cod){
								...
								$tgf.post("<?php echo $configUrl;?>imoveis/proprietarios/carrega-cidade.php", {codEstado: cod}, function(data){
						...
						<form name="formProprietario" action="<?php echo $configUrlGer; ?>imoveis/proprietarios/" method="post">
...
?>
						<script type="text/javascript">
							function buscaAvancada(){
								...
								busca = busca.replace(" ", "-");
								busca = busca.replace(" ", "-");
								$AGD("#busca-carregada").load("<?php echo $configUrl;?>imoveis/proprietarios/busca-proprietarios.php?busca="+busca);
								if(busca == ""){
...
?>
								<tr class="tr">
									<td class="trinta" colspan="9" style="font-weight:bold;"><a href='<?php echo $configUrlGer; ?>imoveis/proprietarios/alterar/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Veja os detalhes do proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>'><?php echo $dadosProprietarios['nomeProprietario'];?></a></td>
								</tr>
<?php
					}else{
?>
								<tr class="tr">
									<td class="trinta"><img style="<?php echo $novaData == date('d/m') ? '' : 'display:none;';?> padding-right:10px; cursor:pointer;" title="Clique para ver o numero" src="<?php echo $configUrl;?>f/i/default/corpo-default/icon-bolo.png" alt="Aniversário" /><a href='<?php echo $configUrlGer; ?>imoveis/proprietarios/alterar/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Veja os detalhes do proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>'><?php echo $dadosProprietarios['nomeProprietario'];?></a></td>
									...
									<td class="vinte" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>imoveis/proprietarios/alterar/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Veja os detalhes do proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>'><?php echo $dadosCidade['nomeCidade'];?> / <?php echo $dadosEstado['siglaEstado'];?></a></td>
									<td class="vinte" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>imoveis/proprietarios/alterar/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Veja os detalhes do proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>'><?php echo $dadosProprietarios['telefoneProprietario'] != "" ? $dadosProprietarios['telefoneProprietario'] : $dadosProprietarios['celularProprietario'];?> <?php echo $dadosProprietarios['telefoneProprietario'] == "" && $dadosProprietarios['celularProprietario'] == "" ? '--' : '';?></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/proprietarios/foto/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Deseja cadastrar fotos para o proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>?'><img style="margin-left:-8px; <?php echo $dadosImagem['codProprietario'] == "" ? 'display:none;' : '';?>" src="<?php echo $configUrlGer.'f/proprietarios/'.$dadosImagem['codProprietario'].'-'.$dadosImagem['codProprietarioImagem'].'-P.'.$dadosImagem['extProprietarioImagem'];?>" alt="icone" height="60"/><img style="<?php echo $dadosImagem['codProprietario'] != "" ? 'display:none;' : '';?>" src="<?php echo $configUrl;?>f/i/gerenciar-imagens.gif" alt="icone" /></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/proprietarios/gerenciar-documentos/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Deseja cadastrar documentos para o proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>?' ><img src="<?php echo $configUrl;?>f/i/geren-documentos.png" alt="icone"/></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/proprietarios/ativacao/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Deseja <?php echo $statusPergunta ?> o proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/proprietarios/alterar/<?php echo $dadosProprietarios['codProprietario'] ?>/' title='Deseja alterar o proprietário <?php echo $dadosProprietarios['nomeProprietario'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								...
								<script>
									 function confirmaExclusao(cod, nome){
										...
										if(confirm("Deseja excluir o proprietário "+nome+"?")){
											window.location='<?php echo $configUrlGer; ?>imoveis/proprietarios/excluir/'+cod+'/';
										}
									  }
								 </script>	 
							</table>							
