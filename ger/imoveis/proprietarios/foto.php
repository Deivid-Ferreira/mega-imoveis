...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/proprietarios/foto/<?php echo $url[6]; ?>/1/" enctype="multipart/form-data" method="post">
...
<?php
				...
				$regPorPag = 14;
				$area = "imoveis/proprietarios/foto/".$url[6];
