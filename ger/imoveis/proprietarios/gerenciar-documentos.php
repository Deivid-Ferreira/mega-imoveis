...
?>	
						<tr class="tr-interno">
							...
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/proprietarios/alterar/<?php echo $dadosNomeProprietario['codProprietario'] ?>/' title='Deseja alterar o proprietário <?php echo $dadosNomeProprietario['nomeProprietario'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar-branco.gif" alt="icone" /></a></td>
						</tr>
					</table>	
					<div class="botao-consultar"><a title="Consultar Proprietários" href="<?php echo $configUrl;?>imoveis/proprietarios/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/proprietarios/gerenciar-documentos/<?php echo $url[6]; ?>/1/" enctype="multipart/form-data" method="post">
...
<?php
				...
				$regPorPag = 14;
				$area = "imoveis/proprietarios/gerenciar-documentos/".$url[6];
