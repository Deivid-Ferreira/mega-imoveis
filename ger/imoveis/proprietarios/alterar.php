...
?>	
					...
					<div class="botao-consultar" style="float:left;"><a href="<?php echo $configUrl;?>imoveis/proprietarios/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
					<br class="clear"/>
				</div>
				<script type="text/javascript">
					...
					function salvaValidade(){
						...
						$ss.post("<?php echo $configUrlGer;?>imoveis/proprietarios/salva-validade.php", {codProprietario: codProprietario, validade: validade}, function(data){	
							if(validade != ""){
...
?>								
						...
						<br/>		
						<form name="formProprietario" action="<?php echo $configUrlGer; ?>imoveis/proprietarios/alterar/<?php echo $url[6] ;?>/" method="post">
