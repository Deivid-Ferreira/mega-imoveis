...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/cidades/ativacao/<?php echo $dadosNomePagamento['codCidade'] ?>/' title='Deseja <?php echo $statusPergunta ?> a cidade <?php echo $dadosNomePagamento['nomeCidade'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Cidade" href="<?php echo $configUrl;?>imoveis/cidades/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/cidades/alterar/<?php echo $url[6] ;?>/" method="post">
