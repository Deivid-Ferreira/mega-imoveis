				...
				<div id="filtro">
					...
					<div class="demoTarget">
						<div id="formulario-filtro">
							...
							<form name="filtro" action="<?php echo $configUrl;?>imoveis/cidades/" method="post" />
...
<?php
				if($_POST['nome'] != ""){
					...
					if($result == 1){
						...
						$_SESSION['estado'] = "";
						echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."imoveis/cidades/'>";					
					}else{
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>imoveis/cidades/" method="post">
...
?>
								...
								<tr class="tr">
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>imoveis/cidades/alterar/<?php echo $dadosCidade['codCidade'] ?>/' title='Veja os detalhes da cidade <?php echo $dadosCidade['nomeCidade'] ?>'><?php echo $dadosCidade['nomeCidade'];?></a></td>
									<td class="dez" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>imoveis/cidades/alterar/<?php echo $dadosCidade['codCidade'] ?>/' title='Veja os detalhes da cidade <?php echo $dadosCidade['nomeCidade'] ?>'><?php echo $dadosCidade['estadoCidade'];?></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/cidades/ativacao/<?php echo $dadosCidade['codCidade'] ?>/' title='Deseja <?php echo $statusPergunta ?> a cidade <?php echo $dadosCidade['nomeCidade'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/cidades/alterar/<?php echo $dadosCidade['codCidade'] ?>/' title='Deseja alterar a cidade <?php echo $dadosCidade['nomeCidade'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								...
								<script>
									 function confirmaExclusao(cod, nome){
										...
										if(confirm("Deseja excluir a cidade "+nome+"?")){
											window.location='<?php echo $configUrlGer; ?>imoveis/cidades/excluir/'+cod+'/';
										}
									  }
								 </script>
