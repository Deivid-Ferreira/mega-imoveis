...
?>
				<div id="localizacao-topo">
					...
					<div class="botao-consultar"><a title="Consultar Quadra" href="<?php echo $configUrl;?>imoveis/quadras/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/quadras/alterar/<?php echo $url[6] ;?>/" method="post">
