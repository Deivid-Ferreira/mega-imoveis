...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/imoveis/alterar/<?php echo $dadosNomeImovel['codImovel'] ?>/' title='Deseja alterar <?php echo $dadosNomeImovel['nomeImovel'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar-branco.gif" alt="icone" /></a></td>
						</tr>
					</table>	
...
-->
						...
						<form enctype="multipart/form-data" method="POST" action="<?php echo $configUrlGer;?>imoveis/imoveis/uploadA.php" onSubmit="return false loading()">
...
-->
						<br/>
						<br/>
						<form action="<?php echo $configUrlGer; ?>imoveis/imoveis/anexos/<?php echo $url[6]; ?>/" enctype="multipart/form-data" method="post">
...
?>	
 ...
 <?php
				...
				$regPorPag = 30;
				$area = "imoveis/imoveis/anexos/".$url[6];
