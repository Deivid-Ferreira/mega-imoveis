...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/tipoImovel/ativacao/<?php echo $dadosNomePagamento['codTipoImovel'] ?>/' title='Deseja <?php echo $statusPergunta ?> o tipo imóvel <?php echo $dadosNomePagamento['nomeTipoImovel'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Tipo Imóvel" href="<?php echo $configUrl;?>imoveis/tipoImovel/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/tipoImovel/alterar/<?php echo $url[6] ;?>/" method="post">
