...
?>
				...
				<div id="filtro">
					...
					<div id="formulario-filtro">
						...
						<form name="filtro" action="<?php echo $configUrl;?>imoveis/tipoImovel/" method="post" />
...
<?php
				if(isset($_POST['cadastrar'])){
					...
					if($result == 1){
						...
						echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."imoveis/tipoImovel/'>";					
					}else{
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>imoveis/tipoImovel/" method="post">
...
?>
							...
							<tr class="tr">
								<td class="oitenta"><a href='<?php echo $configUrlGer; ?>imoveis/tipoImovel/alterar/<?php echo $dadosTipoImovel['codTipoImovel'] ?>/' title='Veja os detalhes do tipo imóvel <?php echo $dadosTipoImovel['nomeTipoImovel'] ?>'><?php echo $dadosTipoImovel['nomeTipoImovel'];?></a></td>
								<td class="dez" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>imoveis/tipoImovel/alterar/<?php echo $dadosTipoImovel['codTipoImovel'] ?>/' title='Veja os detalhes do tipo imóvel <?php echo $dadosTipoImovel['nomeTipoImovel'] ?>'><?php echo $dadosTipoImovel['siglaTipoImovel'];?></a></td>
								<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/tipoImovel/ativacao/<?php echo $dadosTipoImovel['codTipoImovel'] ?>/' title='Deseja <?php echo $statusPergunta ?> o tipo imóvel <?php echo $dadosTipoImovel['nomeTipoImovel'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
								<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/tipoImovel/alterar/<?php echo $dadosTipoImovel['codTipoImovel'] ?>/' title='Deseja alterar o tipo imóvel <?php echo $dadosTipoImovel['nomeTipoImovel'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
							...
							<script>
								 function confirmaExclusao(cod, nome){
									...
									if(confirm("Deseja excluir o tipo imóvel "+nome+"?")){
										window.location='<?php echo $configUrlGer; ?>imoveis/tipoImovel/excluir/'+cod+'/';
									}
								  }
							 </script> 
						</table>	
