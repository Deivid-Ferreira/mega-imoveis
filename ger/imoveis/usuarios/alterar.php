...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/usuarios/ativacao/<?php echo $dadosNomeUsuario['codUsuario'] ?>/' title='Deseja <?php echo $statusPergunta ?> o usuário <?php echo $dadosNomeUsuario['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
							...
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>configuracoes/permissoes/detalhes/<?php echo $dadosNomeUsuario['codUsuario'] ?>/' title='Gerenciar permissões do usuário <?php echo $dadosNomeUsuario['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/permicoes-branco.gif" alt="icone"></a></td>
						</tr>
							<script>
					...
					<div class="botao-consultar"><a href="<?php echo $configUrl;?>imoveis/usuarios/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<br/>
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>imoveis/usuarios/alterar/<?php echo $url[6] ;?>/" method="post">
