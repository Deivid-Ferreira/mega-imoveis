					...
					<div class="demoTarget">
						<script>
							...
							function carregaCidade(cod){
								...
								$tgf.post("<?php echo $configUrl;?>imoveis/usuarios/carrega-cidade.php", {codEstado: cod}, function(data){
						...
						<div id="formulario-filtro">
							<form action="<?php echo $configUrl;?>imoveis/usuarios/" method="post" >							
						...
						if($registrosTotal < $configLimite){
							...
							if($registrosNome == 0){
								...
								if($registros == 0){ 
									...
									$sql = "INSERT INTO usuarios VALUES(0, 1, '".$_POST['nome']."', '".date("Y-m-d")."', '".$_POST['sobrenome']."', '".$_POST['tipo-usuario']."', '".$_POST['rua']."', '".$_POST['numero']."', '".$_POST['bairro']."', '".$_POST['cidade']."', '".$_POST['estado']."', '".$_POST['telefone']."', '".$_POST['celular']."', '".$_POST['email']."', '".$_POST['cpfCol']."', '".$_POST['rg']."', '".$_POST['sexo']."', '".$_POST['usuario']."', '".base64_encode($_POST['senha'])."', 'T')";
									...
									if($result == 1){
										...
										$_SESSION['senha'] = "";
										$_SESSION['confirma-senha'] = "";
										echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."imoveis/usuarios/'>";
									}else{
...
?>				
						...
						<br/>
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>imoveis/usuarios/" method="post" onSubmit="return valida_dados2(this)">
														
							<p class="bloco-campo-float"><label>Nome: <span class="obrigatorio"> * </span></label>
							<input class="campo" type="text" id="nome" name="nome" style="width:250px;" required value="<?php echo $_SESSION['nome']; ?>" /></p>
						
							<p class="bloco-campo-float"><label>Sobrenome: <span class="obrigatorio"> * </span></label>
							<input class="campo" type="text" id="sobrenome" name="sobrenome" style="width:315px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>

							<p class="bloco-campo-float"><label>Tipo Usuário: <span class="obrigatorio"> * </span></label>
							<input class="caixa" name="tipo-usuario" type="radio" value="A" <?php echo $_SESSION['tipo-usuario'] == "A" || $_SESSION['tipo-usuario'] == "" ? 'checked' : ''; ?> />Administrador   <input class="caixa" name="tipo-usuario" type="radio" value="C" <?php echo $_SESSION['tipo-usuario'] == 'C' ? 'checked' : ''; ?> />Corretor</p>
...
?>					
							...
							<input class="campo" type="email" id="email" name="email" style="width:300px;" required value="<?php echo $_SESSION['email']; ?>"/></p>
...
?>
								...
								<tr class="tr">
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>imoveis/usuarios/alterar/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Veja os detalhes do usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>'><?php echo $dadosUsuarioes['nomeUsuario'];?></a></td>
									...
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/usuarios/ativacao/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Deseja <?php echo $statusPergunta ?> o usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/usuarios/alterar/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Deseja alterar o usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								...
								<script>
									 function confirmaExclusao(cod, nome){
										...
										if(confirm("Deseja excluir o usuário "+nome+"?")){
											window.location='<?php echo $configUrlGer; ?>imoveis/usuarios/excluir/'+cod+'/';
										}
									  }
								 </script>
