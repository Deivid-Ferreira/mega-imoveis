		...
		if($controleUsuario == "tem usuario"){
			...
			if($validaAcesso == "ok"){
				...
				if($url[6] != ""){
					...
					$sqlCons = "SELECT nomeCliente, codUsuario FROM clientes WHERE codCliente = ".$url[6].$filtraUsuario." LIMIT 0,1";
					...
					if($dadosCons['codUsuario'] == ""){
						...
						if($result == 1){
							...
							$_SESSION['excluir'] = "ok";
							echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrl."imoveis/clientes/'>";
						}
					}
