...
?>
									<div class="bloco-campo-float"><label class="label">Cidade: <span class="obrigatorio"> * </span></label>
										<select id="cidade" class="campo" name="cidade" required style="width:288px;">
