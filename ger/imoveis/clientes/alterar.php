	...
	if($_COOKIE['loginAprovado'.$cookie] != ""){
		...
		if($controleUsuario == "tem usuario"){
			...
			if($validaAcesso == "ok"){
				...
				$sqlNomeCliente = "SELECT * FROM clientes WHERE codCliente = '".$url[6]."'".$filtraUsuario." LIMIT 0,1";
...
?>	
					...
					<div class="botao-consultar" style="float:left;"><a href="<?php echo $configUrl;?>imoveis/clientes/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
					<br class="clear"/>
				</div>
				<script type="text/javascript">
					...
					function salvaValidade(){
						...
						var codCliente = "<?php echo $url[6];?>";
						
						$ss.post("<?php echo $configUrlGer;?>imoveis/clientes/salva-validade.php", {codCliente: codCliente, validade: validade}, function(data){	
							if(validade != ""){
...
<?php
				if($_POST['alterar'] != ""){
					...
					$sql = "UPDATE clientes SET codUsuario = ".$usuario.", nomeCliente = '".$_POST['nome']."', cpfCliente = '".$_POST['cpf']."', rgCliente = '".$_POST['rg']."', emissorCliente = '".$_POST['emissor']."', sexoCliente = '".$_POST['sexo']."', nascimentoCliente = '".data($_POST['nascimento'])."', enderecoCliente = '".$_POST['endereco']."', bairroCliente = '".$_POST['bairro']."', codEstado = '".$_POST['estado']."', codCidade = '".$_POST['cidade']."', cepCliente = '".$_POST['cep']."', emailCliente = '".$_POST['email']."', telefoneCliente = '".$_POST['telefone']."', celularCliente = '".$_POST['celular']."' WHERE codCliente = ".$url[6]."";
					...
					$_SESSION['usuario'] = $dadosCliente['codUsuario'];
					$_SESSION['cpf'] = $dadosCliente['cpfCliente'];
					$_SESSION['rg'] = $dadosCliente['rgCliente'];
					$_SESSION['emissor'] = $dadosCliente['emissorCliente'];
					$_SESSION['escola'] = $dadosCliente['escolaCliente'];
					$_SESSION['lotacao'] = $dadosCliente['lotacaoCliente'];
					$_SESSION['cargo'] = $dadosCliente['cargoCliente'];
					$_SESSION['matricula'] = $dadosCliente['matriculaCliente'];
					$_SESSION['sexo'] = $dadosCliente['sexoCliente'];
					$_SESSION['contratacao'] = $dadosCliente['contratacaoCliente'];
					$_SESSION['civil'] = $dadosCliente['civilCliente'];
					$_SESSION['situacao'] = $dadosCliente['situacaoCliente'];
					...
					$_SESSION['dependentes'] = $dadosCliente['dependentesCliente'];
				}
...
?>								
						...
						<br/>		
						<form name="formCliente" action="<?php echo $configUrlGer; ?>imoveis/clientes/alterar/<?php echo $url[6] ;?>/" method="post">
...
?>					
							...
							<input class="campo-5" type="text" style="width:150px;" name="nascimento" required id="nascimento" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> value="<?php echo $_SESSION['nascimento']; ?>" onKeyDown="Mascara(this,Data);" onKeyPress="Mascara(this,Data);" onKeyUp="Mascara(this,Data);"/></p>
