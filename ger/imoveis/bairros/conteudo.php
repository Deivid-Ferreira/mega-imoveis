				...
				<div id="filtro">
					...
					<div class="demoTarget">
						<div id="formulario-filtro">
							...
							<form name="filtro" action="<?php echo $configUrl;?>imoveis/bairros/" method="post" />
...
<?php
				if($_POST['nome'] != ""){
					...
					if($result == 1){
						...
						$_SESSION['cidade'] = "";
						echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."imoveis/bairros/'>";					
					}else{
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>imoveis/bairros/" method="post">
...
?>
								...
								<tr class="tr">
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>imoveis/bairros/alterar/<?php echo $dadosBairro['codBairro'] ?>/' title='Veja os detalhes do bairro <?php echo $dadosBairro['nomeBairro'] ?>'><?php echo $dadosBairro['nomeBairro'];?></a></td>
									<td class="vinte" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>imoveis/bairros/alterar/<?php echo $dadosBairro['codBairro'] ?>/' title='Veja os detalhes do bairro <?php echo $dadosBairro['nomeBairro'] ?>'><?php echo $dadosCidades['nomeCidade'];?></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/bairros/ativacao/<?php echo $dadosBairro['codBairro'] ?>/' title='Deseja <?php echo $statusPergunta ?> o bairro <?php echo $dadosBairro['nomeBairro'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/bairros/alterar/<?php echo $dadosBairro['codBairro'] ?>/' title='Deseja alterar o bairro <?php echo $dadosBairro['nomeBairro'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								...
								<script>
									 function confirmaExclusao(cod, nome){
										...
										if(confirm("Deseja excluir o bairro "+nome+"?")){
											window.location='<?php echo $configUrlGer; ?>imoveis/bairros/excluir/'+cod+'/';
										}
									  }
								 </script>								 
							</table>	
