...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>imoveis/bairros/ativacao/<?php echo $dadosNomePagamento['codBairro'] ?>/' title='Deseja <?php echo $statusPergunta ?> o bairro <?php echo $dadosNomePagamento['nomeBairro'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Bairros" href="<?php echo $configUrl;?>imoveis/bairros/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
<?php
				if(isset($_POST['alterar'])){
					...
					$sql = "UPDATE bairros SET codCidade = '".$_POST['cidade']."', nomeBairro = '".$_POST['nome']."', urlBairro = '".$urlBairro."' WHERE codBairro = '".$url[6]."'";
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/bairros/alterar/<?php echo $url[6] ;?>/" method="post">
