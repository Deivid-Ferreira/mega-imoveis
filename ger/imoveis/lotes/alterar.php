...
?>
				<div id="localizacao-topo">
					...
					<div class="botao-consultar"><a title="Consultar Lote" href="<?php echo $configUrl;?>imoveis/lotes/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>imoveis/lotes/alterar/<?php echo $url[6] ;?>/" method="post">
