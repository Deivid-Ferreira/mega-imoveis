				...
				<div id="filtro">
					...
					<div class="demoTarget">
						<div id="formulario-filtro">
							...
							<form name="filtro" action="<?php echo $configUrl;?>imoveis/caracteristicas/" method="post" />
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>imoveis/caracteristicas/" method="post">
...
?>
								...
								<tr class="tr">
									...
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>imoveis/caracteristicas/alterar/<?php echo $dadosCaracteristica['codCaracteristica'] ?>/' title='Veja os detalhes da característica <?php echo $dadosCaracteristica['nomeCaracteristica'] ?>'><?php echo $dadosCaracteristica['nomeCaracteristica'];?></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/caracteristicas/ativacao/<?php echo $dadosCaracteristica['codCaracteristica'] ?>/' title='Deseja <?php echo $statusPergunta ?> a característica <?php echo $dadosCaracteristica['nomeCaracteristica'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>imoveis/caracteristicas/alterar/<?php echo $dadosCaracteristica['codCaracteristica'] ?>/' title='Deseja alterar a característica <?php echo $dadosCaracteristica['nomeCaracteristica'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
...
?>
								...
								<script type="text/javascript">
									...
									function alteraOrdem(cod, ordem){
										...
										$po.post("<?php echo $configUrlGer;?>imoveis/caracteristicas/ordem.php", {codCaracteristica: cod, codOrdenacaoCaracteristica: ordem}, function(data){		
