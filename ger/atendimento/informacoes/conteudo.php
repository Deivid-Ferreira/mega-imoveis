...
?>						
						...
						<form action="<?php echo $configUrlGer; ?>atendimento/informacoes/" method="post">
							...
							<p class="bloco-campo-float"><label>Horário de atendimentio: <span class="obrigatorio"> </span></label>
							<input id="hora"  <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="atendimento" style="width:497px;" value="<?php echo $_SESSION['atendimento']; ?>" /></p>
