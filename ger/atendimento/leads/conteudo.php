...
<?php
					...
					while($dadosLead = $resultLead->fetch_assoc()){
						...
						$telefone = $dadosLead['celularLead'];
...
?>
								<tr class="tr">
									...
									<td class="botoes" style="display: flex; align-itens:center;"><a target="_blank" href='https://wa.me/55<?php echo $telefoneLimpo ?>' title='Enviar menssagem pelo WhatsApp' ><img style="margin-top: 14px;" src="<?php echo $configUrl.'f/i/whats-verde.svg' ?>" alt="" width="38px"></a></td>
