...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/servicos/ativacao/<?php echo $dadosNomePagamento['codServico'] ?>/' title='Deseja <?php echo $statusPergunta ?> o serviço <?php echo $dadosNomePagamento['nomeServico'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
							<td class="botoes-interno"><a href='javascript: confirmaExclusao(<?php echo $dadosNomePagamento['codServico'] ?>, "<?php echo htmlspecialchars($dadosNomePagamento['nomeServico']) ?>");' title='Deseja excluir o serviço <?php echo $dadosNomePagamento['nomeServico'] ?>?' ><img src='<?php echo $configUrl; ?>f/i/default/corpo-default/excluir-branco.gif' alt="icone"></a></td>
						</tr>
						<script>
					...
					<div class="botao-consultar"><a title="Consultar Serviços" href="<?php echo $configUrl;?>cadastros/servicos/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
<?php
				if(isset($_POST['alterar'])){
					...
					if($result == 1){
						...
						$erroData = "<p class='erro'>Problemas ao alterar serviço!</p>";
					}
				}else{
