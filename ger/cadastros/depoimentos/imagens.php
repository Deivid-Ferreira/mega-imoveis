...
?>	
					...
					<div class="botao-consultar"><a title="Consultar Depoimentos Capa" href="<?php echo $configUrl;?>cadastros/depoimentos/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
<?php
				if($url[6] == 0){
?>							
							<p class="bloco-campo"><label class="label" style="font-size:15px; line-height:20px; font-weight:normal;"><strong>Extensão:</strong> png, jpg ou jpeg <strong>Tamanho:</strong> 1920 x 320</labeL>
							<input class="campo" type="file" name="imagem" style="width:390px; margin-top:10px;" value="" /></p>
<?php
				}else{
?>
							<p class="bloco-campo"><label class="label" style="font-size:15px; line-height:20px; font-weight:normal;"><strong>Extensão:</strong> png,jpg ou jpeg <strong>Tamanho:</strong> 500 x 500</labeL>
							<input class="campo" type="file" name="imagem" style="width:390px; margin-top:10px;" value="" /></p>
<?php
				}
?>							
...
?>       
								<div class="imagem" style="width:200px; height:200px; margin-right:30px;">
									<p style="width:200px; height:142px; display:table-cell; vertical-align:middle;"><img src="<?php echo $configUrl."f/depoimentos/".$dadosImagem['codDepoimento'].'-'.$dadosImagem['codDepoimentoImagem'].'-W.webp';?>" alt="Imagem Depoimento" width="250"/><br/></p>
