				...
				if($url[5] != ""){
					...
					while($dadosExcluiImagens = $resultExcluiImagens->fetch_assoc()){
						...
						if(file_exists("f/blog/".$dadosExcluiImagens['codBlog']."-".$dadosExcluiImagens['codBlogImagem']."-O.".$dadosExcluiImagens['extBlogImagem'])){
							...
							unlink("f/blog/".$dadosExcluiImagens['codBlog']."-".$dadosExcluiImagens['codBlogImagem']."-P.".$dadosExcluiImagens['extBlogImagem']);
							unlink("f/blog/".$dadosExcluiImagens['codBlog']."-".$dadosExcluiImagens['codBlogImagem']."-M.".$dadosExcluiImagens['extBlogImagem']);
							unlink("f/blog/".$dadosExcluiImagens['codBlog']."-".$dadosExcluiImagens['codBlogImagem']."-G.".$dadosExcluiImagens['extBlogImagem']);
						}
					...
					echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrl."cadastros/blog/'>";
