...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/blog/ativacao/<?php echo $dadosNomePagamento['codBlog'] ?>/' title='Deseja <?php echo $statusPergunta ?> o blog <?php echo $dadosNomePagamento['nomeBlog'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
...
<?php
				if(isset($_POST['alterar'])){
					...
					if($result == 1){
						...
						$erroData = "<p class='erro'>Problemas ao alterar blog!</p>";
					}
				}else{
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/blog/alterar/<?php echo $url[6] ;?>/" method="post">
