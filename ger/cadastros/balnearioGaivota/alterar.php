...
<?php
				if(isset($_POST['alterar'])){
					...
					if($result == 1){
						...
						echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."cadastros/balnearioGaivota/'>";
					}else{
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/balnearioGaivota/alterar/<?php echo $url[6] ;?>/" method="post">
