...
?>
				...
				<div id="dados-conteudo">
					<div id="col-esq-pref" style="width:20%;">
						...
						<p class="<?php echo $url[4] == 'usuarios' ? 'menu-pref-usuarios-ativo' : 'menu-pref-usuarios' ;?>"><a href="<?php echo $configUrl;?>imoveis/usuarios" title="Usuários">Usuários</a></p>
					</div>
					<div id="consultas" style="float:left; width:76%;">
						<div class="botao-novo" style="margin-bottom:20px;"><a title="Novo E-mail" href="<?php echo $configUrl;?>imoveis/usuarios"><div class="esquerda-novo"></div><div class="conteudo-novo">Novo Usuário</div><div class="direita-novo"></div></a></div>	
