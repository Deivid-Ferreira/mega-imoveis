...
?>	
					<div id="conteudo-interno">
						<div id="bloco-titulo">
							<p class="titulo">A IMOBILIÁRIA</p>
						</div>	
...
<?php
	...
	$sqlImagemConta = "SELECT count(codQuemSomos) total FROM quemSomosImagens WHERE codQuemSomos = ".$dadosQuemSomos['codQuemSomos']." and codQuemSomosImagem != ".$dadosImagemP['codQuemSomosImagem']."";
...
?>
							<div id="mais-imagens">
<?php
		$sqlImagem = "SELECT * FROM quemSomosImagens WHERE codQuemSomos = ".$dadosQuemSomos['codQuemSomos']." and codQuemSomosImagem != ".$dadosImagemP['codQuemSomosImagem']." ORDER BY  codQuemSomosImagem ASC";
